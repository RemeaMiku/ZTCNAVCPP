...
public:
	...
	inline constexpr unsigned int Week() const noexcept { return _week; }
	inline constexpr double Second() const noexcept { return _second; }
	inline std::string ToString() const { return std::format("{} {:.9f}", _week, _second); }
