...
*          double *Q     I  covariance matrix of float parameters (n x n) //浮点解协方差阵
*          double *F     O  fixed solutions (n x m) //两组固定解
*          double *s     O  sum of squared residulas of fixed solutions (1 x m) //LAMBDA浮点解中的模糊度残差
