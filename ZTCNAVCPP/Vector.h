...
public:
	...
	/// <param name="i"></param>
	/// <returns></returns>
	inline constexpr double& operator [](int i) noexcept
	{
		return _elements[i];
	}
	inline constexpr const double& operator [](int i) const noexcept
	{
		return _elements[i];
	}
	...
	inline const constexpr double& operator()(int i) const
	{
